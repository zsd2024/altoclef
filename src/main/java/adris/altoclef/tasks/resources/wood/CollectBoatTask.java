...
/**
 * 收集木船任务
 * 该任务负责收集指定数量的木船，通过使用匹配的木板进行合成
 */
public class CollectBoatTask extends CraftWithMatchingPlanksTask {

    /**
     * 构造函数，指定目标木船类型、所需木板和数量
     * @param targets 目标木船物品数组
    ...
    private static CraftingRecipe createRecipe(ItemTarget planks) {
        ...
        return CraftingRecipe.newShapedRecipe(new ItemTarget[]{p, o, p, p, p, p, o, o, o}, 1); // 制作木船的配方布局，制作1个船
    }
}
